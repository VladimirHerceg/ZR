      ...
      <div class="container-fluid mx-0 px-0">
          <div class="row justify-content-center mx-0 px-0" style="margin-top: 35px">  
                      ...
                      <div class="col-12">
                        ...
                        <textarea class="form-control  text-center" id="content" placeholder="Content" name="content"></textarea>
                      </div>
                      ...
                      <label class="col-1 text-dark bg-light" for="image">Click here to choose image</label>
                      <div class="col-10 text-center"></div>
           ...
           <span id="all_error" class="error"></span><br><br>
                  ...
                  <input type="submit" class="btn btn-info col-3" value="Upload">
              </form>
              </div>
              </div>';
        break;
